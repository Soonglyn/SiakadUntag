...
if (isset($_GET['edit'])) {
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        echo "<script>alert('Data dosen tidak ditemukan.'); window.location.href='dosen.php';</script>";
    }
}
...
<div class="menu">
    ...
    <div class="content">
        ...
        <form action="editDosen.php?edit=<?php echo urlencode($row['id']); ?>" method="post">
            <div class="mb-3">
                <label for="kodedsn" class="form-label">Kode Dosen</label>
                <input type="text" id="kodedsn" name="kodedsn" class="form-control" value="<?php echo htmlspecialchars($row['kodedsn']); ?>" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="jabatan" name="jabatan" class="form-control" value="<?php echo htmlspecialchars($row['jabatan']); ?>" required>
            </div>
