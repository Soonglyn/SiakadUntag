...
// Function for SELECT with Pagination
function tampilData($conn) {
    ...
    $totalQuery = "SELECT COUNT(*) as total FROM dosen WHERE kodedsn LIKE '%$search%' OR nama LIKE '%$search%'";
    ...
    $sql = "SELECT * FROM dosen WHERE kodedsn LIKE '%$search%' OR nama LIKE '%$search%' LIMIT $limit OFFSET $offset";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            echo "<tr>
                    <td>" . $no++ . "</td>
                    <td>" . htmlspecialchars($row['kodedsn']) . "</td>
                    <td>" . htmlspecialchars($row['nama']) . "</td>
                    <td>" . htmlspecialchars($row['alamat']) . "</td>
                    <td>" . htmlspecialchars($row['prodi']) . "</td>
                    <td>" . htmlspecialchars($row['jabatan']) . "</td>
                    <td>
                         <a href='editDosen.php?edit=" . urlencode($row['id']) . "' class='edit-btn'>Edit</a> |
                         <a href='hapusDosen.php?hapus=" . urlencode($row['id']) . "' class='delete-btn'>Hapus</a>
                    </td>
                <tr>";
        }
        echo "</tbody>";
